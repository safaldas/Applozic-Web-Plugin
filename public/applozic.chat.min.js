...
'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e';else if(msg.fileMeta.hasOwnProperty("url"))if(msg.fileMeta.url.indexOf("www.googleapis.com")!==-1){var thumbnailUrl;_this.generatecloudurl(msg.fileMeta.thumbnailBlobKey,function(result){thumbnailUrl=result});return'\x3ca href\x3d"#" role\x3d"link" target\x3d"_self" class\x3d"file-preview-link fancybox-media imageview" data-type\x3d"'+msg.fileMeta.contentType+'" data-url\x3d"" data-blobKey\x3d"'+msg.fileMeta.blobKey+'" data-name\x3d"'+msg.fileMeta.name+
...
'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e';else if(msg.fileMeta.contentType.indexOf("video")!==-1)if(msg.fileMeta.hasOwnProperty("url")&&msg.fileMeta.url.indexOf("www.googleapis.com")!==-1){var getUrl;_this.generatecloudurl(msg.fileMeta.blobKey,function(result){getUrl=result});return'\x3ca href\x3d"#" target\x3d"_self"\x3e\x3cvideo controls class\x3d"mck-video-player" onplay\x3d"alFileService.updateAudVidUrl(this);" data-cloud-service\x3d"google_cloud" data-blobKey\x3d"'+msg.fileMeta.blobKey+
...
msg.fileMeta.url.indexOf("www.googleapis.com")!==-1){var getUrl;_this.generatecloudurl(msg.fileMeta.blobKey,function(result){getUrl=result});return'\x3ca href\x3d"#" target\x3d"_self"\x3e\x3caudio controls class\x3d"mck-audio-player" onplay\x3d"alFileService.updateAudVidUrl(this);" data-cloud-service\x3d"google_cloud" data-blobKey\x3d"'+msg.fileMeta.blobKey+'"\x3e'+'\x3csource src\x3d"'+getUrl+'" type\x3d"audio/ogg"\x3e'+'\x3csource src\x3d"'+getUrl+'" type\x3d"audio/mpeg"\x3e\x3c/audio\x3e'+'\x3cp class\x3d"mck-file-tag"\x3e\x3c/p\x3e\x3c/a\x3e'}else return'\x3ca href\x3d"#" target\x3d"_self"\x3e\x3caudio controls class\x3d"mck-audio-player"\x3e'+
'\x3csource src\x3d"'+_this.getFileurl(msg)+'" type\x3d"audio/ogg"\x3e'+'\x3csource src\x3d"'+_this.getFileurl(msg)+'" type\x3d"audio/mpeg"\x3e\x3c/audio\x3e'+'\x3cp class\x3d"mck-file-tag"\x3e\x3c/p\x3e\x3c/a\x3e';else return'\x3ca href\x3d"#" role\x3d"link" class\x3d"file-preview-link" target\x3d"_blank"\x3e\x3c/a\x3e';return""};_this.updateAudVidUrl=function(element){var keygen=element.dataset.blobkey;var time=(new Date).getTime();console.log(time);var currentSrc=element.currentSrc;var expiry=
_this.fetchQueryString("Expires",currentSrc);if(time>=expiry*1E3){_this.generatecloudurl(keygen,function(result){getUrl=result});element.src=getUrl}};this.fetchQueryString=function(regKey,href){regKey=regKey.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var regexValue=new RegExp("[\\?\x26]"+regKey+"\x3d([^\x26#]*)");var result=regexValue.exec(href);if(result==null)alert("The parameter is null");else console.log(result[1]*1E3);return result[1]};_this.getFileAttachment=function(msg){if(typeof msg.fileMeta===
"object"){if(msg.fileMeta.contentType.indexOf("image")!==-1||msg.fileMeta.contentType.indexOf("audio")!==-1||msg.fileMeta.contentType.indexOf("video")!==-1)if(msg.fileMeta.hasOwnProperty("url")&&msg.fileMeta.url.indexOf("www.googleapis.com")!==-1)return'\x3ca href\x3d"javascript:void(0);" role\x3d"link" target\x3d"_self"  class\x3d"file-preview-link" data-blobKey\x3d"'+msg.fileMeta.blobKey+'" data-cloud-service\x3d"google_cloud"\x3e\x3cspan class\x3d"file-detail mck-image-download"\x3e\x3cspan class\x3d"mck-file-name"\x3e\x3cspan class\x3d"mck-icon-attachment"\x3e\x3c/span\x3e\x26nbsp;'+
