...
r},n.qs=o,n.location=i,e.exports=n},{"./lolcation":57,querystringify:58,"requires-port":59}],57:[function(t,e){(function(n){var r,i={hash:1,query:1};e.exports=function(e){e=e||n.location||{},r=r||t("./");var o,s={},a=typeof e;if("blob:"===e.protocol)s=new r(unescape(e.pathname),{});else if("string"===a){s=new r(e,{});for(o in i)delete s[o]}else if("object"===a)for(o in e)o in i||(s[o]=e[o]);return s}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?
window:{})},{"./":56}],58:[function(t,e,n){function r(t){for(var e,n=/([^=?&]+)=([^&]*)/g,r={};e=n.exec(t);r[decodeURIComponent(e[1])]=decodeURIComponent(e[2]));return r}function i(t,e){e=e||"";var n=[];"string"!=typeof e&&(e="?");for(var r in t)o.call(t,r)&&n.push(encodeURIComponent(r)+"\x3d"+encodeURIComponent(t[r]));return n.length?e+n.join("\x26"):""}var o=Object.prototype.hasOwnProperty;n.stringify=i,n.parse=r},{}],59:[function(t,e){e.exports=function(t,e){if(e=e.split(":")[0],t=+t,!t)return!1;
switch(e){case "http":case "ws":return 80!==t;case "https":case "wss":return 443!==t;case "ftp":return 22!==t;case "gopher":return 70!==t;case "file":return!1}return 0!==t}},{}]},{},[1])(1)}),function(){var t,e,n,r,i={}.hasOwnProperty,o=[].slice;t={LF:"\n",NULL:"\x00"},n=function(){function e(t,e,n){this.command=t,this.headers=null!=e?e:{},this.body=null!=n?n:""}var n;return e.prototype.toString=function(){var n,r,o,s,a;n=[this.command],o=this.headers["content-length"]===!1?!0:!1,o&&delete this.headers["content-length"],
a=this.headers;for(r in a)i.call(a,r)&&(s=a[r],n.push(""+r+":"+s));return this.body&&!o&&n.push("content-length:"+e.sizeOfUTF8(this.body)),n.push(t.LF+this.body),n.join(t.LF)},e.sizeOfUTF8=function(t){return t?encodeURI(t).match(/%..|./g).length:0},n=function(n){var r,i,o,s,a,u,c,l,f,h,d,p,v,m,b,y,g;for(s=n.search(RegExp(""+t.LF+t.LF)),a=n.substring(0,s).split(t.LF),o=a.shift(),u={},p=function(t){return t.replace(/^\s+|\s+$/g,"")},y=a.reverse(),v=0,b=y.length;b>v;v++)h=y[v],l=h.indexOf(":"),u[p(h.substring(0,
l))]=p(h.substring(l+1));if(r="",d=s+2,u["content-length"])f=parseInt(u["content-length"]),r=(""+n).substring(d,d+f);else for(i=null,c=m=d,g=n.length;(g>=d?g>m:m>g)&&(i=n.charAt(c),i!==t.NULL);c=g>=d?++m:--m)r+=i;return new e(o,u,r)},e.unmarshall=function(e){var r;return function(){var i,o,s,a;for(s=e.split(RegExp(""+t.NULL+t.LF+"*")),a=[],i=0,o=s.length;o>i;i++)r=s[i],(null!=r?r.length:void 0)>0&&a.push(n(r));return a}()},e.marshall=function(n,r,i){var o;return o=new e(n,r,i),o.toString()+t.NULL},
e}(),e=function(){function e(t){this.ws=t,this.ws.binaryType="arraybuffer",this.counter=0,this.connected=!1,this.heartbeat={outgoing:1E4,incoming:1E4},this.maxWebSocketFrameSize=16384,this.subscriptions={}}var i;return e.prototype.debug=function(t){var e;return"undefined"!=typeof window&&null!==window?(null!=(e=window.console),void 0):void 0},i=function(){return Date.now?Date.now():(new Date).valueOf},e.prototype._transmit=function(t,e,r){var i;for(i=n.marshall(t,e,r),"function"==typeof this.debug&&
this.debug("\x3e\x3e\x3e "+i);;){if(!(i.length>this.maxWebSocketFrameSize))return this.ws.send(i);this.ws.send(i.substring(0,this.maxWebSocketFrameSize)),i=i.substring(this.maxWebSocketFrameSize),"function"==typeof this.debug&&this.debug("remaining \x3d "+i.length)}},e.prototype._setupHeartbeat=function(e){var n,o,s,a,u,c;if((u=e.version)===r.VERSIONS.V1_1||u===r.VERSIONS.V1_2)return c=function(){var t,n,r,i;for(r=e["heart-beat"].split(","),i=[],t=0,n=r.length;n>t;t++)a=r[t],i.push(parseInt(a));return i}(),
o=c[0],n=c[1],0!==this.heartbeat.outgoing&&0!==n&&(s=Math.max(this.heartbeat.outgoing,n),"function"==typeof this.debug&&this.debug("send PING every "+s+"ms"),this.pinger=r.setInterval(s,function(e){return function(){return e.ws.send(t.LF),"function"==typeof e.debug?e.debug("\x3e\x3e\x3e PING"):void 0}}(this))),0!==this.heartbeat.incoming&&0!==o?(s=Math.max(this.heartbeat.incoming,o),"function"==typeof this.debug&&this.debug("check PONG every "+s+"ms"),this.ponger=r.setInterval(s,function(t){return function(){var e;
return e=i()-t.serverActivity,e>2*s?("function"==typeof t.debug&&t.debug("did not receive server activity for the last "+e+"ms"),t.ws.close()):void 0}}(this))):void 0},e.prototype._parseConnect=function(){var t,e,n,r;switch(t=1<=arguments.length?o.call(arguments,0):[],r={},t.length){case 2:r=t[0],e=t[1];break;case 3:t[1]instanceof Function?(r=t[0],e=t[1],n=t[2]):(r.login=t[0],r.passcode=t[1],e=t[2]);break;case 4:r.login=t[0],r.passcode=t[1],e=t[2],n=t[3];break;default:r.login=t[0],r.passcode=t[1],
e=t[2],n=t[3],r.host=t[4]}return[r,e,n]},e.prototype.connect=function(){var e,s,a,u;return e=1<=arguments.length?o.call(arguments,0):[],u=this._parseConnect.apply(this,e),a=u[0],this.connectCallback=u[1],s=u[2],"function"==typeof this.debug&&this.debug("Opening Web Socket..."),this.ws.onmessage=function(e){return function(r){var o,a,u,c,l,f,h,d,p,v,m,b;if(c="undefined"!=typeof ArrayBuffer&&r.data instanceof ArrayBuffer?(o=new Uint8Array(r.data),"function"==typeof e.debug?e.debug("--- got data length: "+
o.length):void 0,function(){var t,e,n;for(n=[],t=0,e=o.length;e>t;t++)a=o[t],n.push(String.fromCharCode(a));return n}().join("")):r.data,e.serverActivity=i(),c===t.LF)return void("function"==typeof e.debug&&e.debug("\x3c\x3c\x3c PONG"));for("function"==typeof e.debug&&e.debug("\x3c\x3c\x3c "+c),m=n.unmarshall(c),b=[],p=0,v=m.length;v>p;p++)switch(l=m[p],l.command){case "CONNECTED":"function"==typeof e.debug&&e.debug("connected to server "+l.headers.server),e.connected=!0,e._setupHeartbeat(l.headers),
b.push("function"==typeof e.connectCallback?e.connectCallback(l):void 0);break;case "MESSAGE":d=l.headers.subscription,h=e.subscriptions[d]||e.onreceive,h?(u=e,f=l.headers["message-id"],l.ack=function(t){return null==t&&(t={}),u.ack(f,d,t)},l.nack=function(t){return null==t&&(t={}),u.nack(f,d,t)},b.push(h(l))):b.push("function"==typeof e.debug?e.debug("Unhandled received MESSAGE: "+l):void 0);break;case "RECEIPT":b.push("function"==typeof e.onreceipt?e.onreceipt(l):void 0);break;case "ERROR":b.push("function"==
typeof s?s(l):void 0);break;default:b.push("function"==typeof e.debug?e.debug("Unhandled frame: "+l):void 0)}return b}}(this),this.ws.onclose=function(t){return function(){var e;return e="Whoops! Lost connection to "+t.ws.url,"function"==typeof t.debug&&t.debug(e),t._cleanUp(),"function"==typeof s?s(e):void 0}}(this),this.ws.onopen=function(t){return function(){return"function"==typeof t.debug&&t.debug("Web Socket Opened..."),a["accept-version"]=r.VERSIONS.supportedVersions(),a["heart-beat"]=[t.heartbeat.outgoing,
...
e,n)},e.prototype.subscribe=function(t,e,n){var r;return null==n&&(n={}),n.id||(n.id="sub-"+this.counter++),n.destination=t,this.subscriptions[n.id]=e,this._transmit("SUBSCRIBE",n),r=this,{id:n.id,unsubscribe:function(){return r.unsubscribe(n.id)}}},e.prototype.unsubscribe=function(t){return delete this.subscriptions[t],this._transmit("UNSUBSCRIBE",{id:t})},e.prototype.begin=function(t){var e,n;return n=t||"tx-"+this.counter++,this._transmit("BEGIN",{transaction:n}),e=this,{id:n,commit:function(){return e.commit(n)},
abort:function(){return e.abort(n)}}},e.prototype.commit=function(t){return this._transmit("COMMIT",{transaction:t})},e.prototype.abort=function(t){return this._transmit("ABORT",{transaction:t})},e.prototype.ack=function(t,e,n){return null==n&&(n={}),n["message-id"]=t,n.subscription=e,this._transmit("ACK",n)},e.prototype.nack=function(t,e,n){return null==n&&(n={}),n["message-id"]=t,n.subscription=e,this._transmit("NACK",n)},e}(),r={VERSIONS:{V1_0:"1.0",V1_1:"1.1",V1_2:"1.2",supportedVersions:function(){return"1.1,1.0"}},
client:function(t,n){var i,o;return null==n&&(n=["v10.stomp","v11.stomp"]),i=r.WebSocketClass||WebSocket,o=new i(t,n),new e(o)},over:function(t){return new e(t)},Frame:n},"undefined"!=typeof exports&&null!==exports&&(exports.Stomp=r),"undefined"!=typeof window&&null!==window?(r.setInterval=function(t,e){return window.setInterval(e,t)},r.clearInterval=function(t){return window.clearInterval(t)},window.Stomp=r):exports||(self.Stomp=r)}.call(this);var w=window,d=document;var MCK_LABELS;var MCK_BASE_URL;
var MCK_CURR_LATITIUDE=40.7324319;var MCK_CURR_LONGITUDE=-73.82480777777776;var mckUtils=new MckUtils;var mckDateUtils=new MckDateUtils;var mckContactUtils=new MckContactUtils;var mckMapUtils=new MckMapUtils;
...
"?groupId\x3d"+options.data.group.groupId:"?clientGroupId\x3d"+options.data.group.clientGroupId;ALApiService.ajax({url:MCK_BASE_URL+GROUP_INFO_URL+groupId,type:"get",async:typeof options.async!=="undefined"?options.async:true,global:false,success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.error(response)}})};ALApiService.addGroupMember=function(options){ALApiService.ajax({url:MCK_BASE_URL+GROUP_ADD_MEMBER_URL,type:"POST",data:JSON.stringify(options.data.group),
...
ALApiService.unBlockUser=function(options){ALApiService.ajax({url:MCK_BASE_URL+USER_UNBLOCK_URL+"?userId\x3d"+options.data.userId,type:"GET",async:typeof options.async!=="undefined"?options.async:true,global:false,success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.error(response)}})};ALApiService.sendConversationCloseUpdate=function(options){var data="id\x3d"+options.conversationId;ALApiService.ajax({url:MCK_BASE_URL+CONVERSATION_CLOSE_UPDATE_URL,
data:data,global:false,type:"get",success:function(){},error:function(){}})};ALApiService.fileUpload=function(options){ALApiService.ajax({type:"GET",url:options.data.url,global:false,data:"data\x3d"+(new Date).getTime(),crosDomain:true,success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.error(response)}})};ALApiService.sendAttachment=function(options){var data=new FormData;var xhr=new XMLHttpRequest;xhr.addEventListener("load",
function(e){var file=this.responseText;var message=options.data.messagePxy;if(file){message.fileMeta=JSON.parse(file);Applozic.ALApiService.sendMessage({data:{message},success:function(response){console.log(response)},error:function(){}})}});data.append("file",options.data.file);xhr.open("post",MCK_BASE_URL+ATTACHMENT_UPLOAD_URL,true);xhr.setRequestHeader("UserId-Enabled",true);xhr.setRequestHeader("Authorization","Basic "+AUTH_CODE);xhr.setRequestHeader("Application-Key",MCK_APP_ID);xhr.setRequestHeader("Device-Key",
DEVICE_KEY);if(ACCESS_TOKEN)xhr.setRequestHeader("Access-Token",ACCESS_TOKEN);xhr.send(data)};ALApiService.deleteFileMeta=function(options){ALApiService.ajax({url:options.data.url,type:"post",success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.error(response)}})};ALApiService.addMessageInbox=function(options){ALApiService.ajax({type:"GET",url:MCK_BASE_URL+MESSAGE_ADD_INBOX_URL,global:false,data:"sender\x3d"+encodeURIComponent(options.data.sender)+
"\x26messageContent\x3d"+encodeURIComponent(options.data.messageContent),contentType:"text/plain",success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.error(response)}})};ALApiService.conversationReadUpdate=function(options){ALApiService.ajax({url:MCK_BASE_URL+CONVERSATION_READ_UPDATE_URL,data:options.data,global:false,type:"get",success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.success(response)}})};
ALApiService.sendSubscriptionIdToServer=function(options){var subscriptionId=options.data.subscriptionId;ALApiService.ajax({url:MCK_BASE_URL+MCK_SW_REGISTER_URL,type:"post",data:"registrationId\x3d"+subscriptionId,success:function(data){},error:function(xhr,desc,err){if(xhr.status===401){sessionStorage.clear();console.log("Please reload page.")}}})};ALApiService.getTopicId=function(options){var conversationId="id\x3d"+options.data.conversationId;ALApiService.ajax({url:MCK_BASE_URL+TOPIC_ID_URL+"?"+
conversationId,type:"get",success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.success(response)}})};ALApiService.getContactDisplayName=function(options){var userIdArray=options.data.userIdArray;if(userIdArray.length>0&&userIdArray[0]){var data="";var uniqueUserIdArray=userIdArray.filter(function(item,pos){return userIdArray.indexOf(item)===pos});for(var i=0;i<uniqueUserIdArray.length;i++){var userId=uniqueUserIdArray[i];if(typeof MCK_CONTACT_NAME_MAP[userId]===
"undefined")data+="userIds\x3d"+encodeURIComponent(userId)+"\x26"}if(data.lastIndexOf("\x26")===data.length-1)data=data.substring(0,data.length-1);if(data)ALApiService.ajax({url:MCK_BASE_URL+CONTACT_NAME_URL,data:data,global:false,type:"get",success:function(response){if(options.success)options.success(response)},error:function(response){if(options.error)options.success(response)}})}};ALApiService.getUserStatus=function(options){ALApiService.ajax({url:MCK_BASE_URL+USER_STATUS_URL,type:"get",success:function(response){if(options.success)options.success(response)},
...
function AlUserService(){var _this=this;_this.MCK_USER_DETAIL_MAP=[];_this.MCK_BLOCKED_TO_MAP=[];var MCK_GROUP_MEMBER_SEARCH_ARRAY=new Array;var USER_BLOCK_URL="/rest/ws/user/block";var USER_DETAIL_URL="/rest/ws/user/v2/detail";var USER_STATUS_URL="/rest/ws/user/chat/status";_this.updateUserStatus=function(params,callback){if(typeof alUserService.MCK_USER_DETAIL_MAP[params.userId]==="object"){var userDetail=alUserService.MCK_USER_DETAIL_MAP[params.userId];if(params.status===0){userDetail.connected=
false;userDetail.lastSeenAtTime=params.lastSeenAtTime}else if(params.status===1)userDetail.connected=true}else{var userIdArray=new Array;userIdArray.push(params.userId);if(typeof callback==="function")callback(userIdArray)}};_this.getUserDetail=function(userId){if(typeof alUserService.MCK_USER_DETAIL_MAP[userId]==="object")return alUserService.MCK_USER_DETAIL_MAP[userId];else return};_this.checkUserConnectedStatus=function(callback){var userIdArray=new Array;var otherUserIdArray=new Array;$applozic(".mck-user-ol-status").each(function(){var tabId=
$applozic(this).data("mck-id");if(typeof tabId!=="undefined"&&tabId!==""){userIdArray.push(tabId);var htmlId=mckContactUtils.formatContactId(""+tabId);$applozic(this).addClass(htmlId);$applozic(this).next().addClass(htmlId)}});if(userIdArray.length>0){$applozic.each(userIdArray,function(i,userId){if(typeof alUserService.MCK_USER_DETAIL_MAP[userId]==="undefined")otherUserIdArray.push(userId)});if(typeof callback==="function")callback(otherUserIdArray)}};_this.loadUserProfile=function(userId){if(typeof userId!==
"undefined"){var userIdArray=[];var memberId=""+userId.split(",")[0];userIdArray.push(memberId);_this.loadUserProfiles(userIdArray)}};_this.loadUserProfiles=function(userIds,callback){var userIdArray=[];if(typeof callback==="function")callback(userIds,userIdArray)};_this.getUserStatus=function(params,callback){var response=new Object;window.Applozic.ALApiService.getUserStatus({success:function(data){if(data.users.length>0){MCK_GROUP_MEMBER_SEARCH_ARRAY=[];if(typeof callback==="function")callback(data)}response.status=
"success";response.data=data;if(params.callback)params.callback(response);return},error:function(){response.status="error";if(params.callback)params.callback(response)}})};_this.blockUser=function(userId,isBlock,callback){if(!userId||typeof isBlock==="undefined")return;var data="userId\x3d"+userId+"\x26block\x3d"+isBlock;mckUtils.ajax({url:MCK_BASE_URL+USER_BLOCK_URL,type:"get",data:data,success:function(data){if(typeof data==="object")if(data.status==="success"){alUserService.MCK_BLOCKED_TO_MAP[userId]=
isBlock;if(typeof callback==="function")callback(userId)}},error:function(){}})}}var alFileService=new AlFileService;
