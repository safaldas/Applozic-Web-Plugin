...
"/files/"+msg.fileMeta.name;else{console.log("test",MCK_FILE_URL+FILE_PREVIEW_URL+msg.fileMeta.blobKey);return MCK_FILE_URL+FILE_PREVIEW_URL+msg.fileMeta.blobKey}return""};_this.generateCloudUrl=function(key,callback){var url=MCK_GENERATE_CLOUD_FILE_URL.replace("{key}",key);var headers=window.Applozic.ALApiService.getAttachmentHeaders();mckUtils.ajax({type:"get",async:false,headers:headers,url:url,success:function(result){if(typeof callback==="function")callback(result)},error:function(result){console.log("error while getting token"+
result)}})};_this.getFilePath=function(msg){if(msg.contentType===2)try{var geoLoc=$applozic.parseJSON(msg.message);if(geoLoc.lat&&geoLoc.lon)return'\x3ca href\x3d"http://maps.google.com/maps?z\x3d17\x26t\x3dm\x26q\x3dloc:'+geoLoc.lat+","+geoLoc.lon+'" target\x3d"_blank"\x3e\x3cimg src\x3d"https://maps.googleapis.com/maps/api/staticmap?zoom\x3d17\x26size\x3d200x150\x26center\x3d'+geoLoc.lat+","+geoLoc.lon+"\x26maptype\x3droadmap\x26markers\x3dcolor:red|"+geoLoc.lat+","+geoLoc.lon+"\x26key\x3d"+MCK_MAP_STATIC_API_KEY+
'"/\x3e\x3c/a\x3e'}catch(ex){if(msg.message.indexOf(",")!==-1)return'\x3ca href\x3d"http://maps.google.com/maps?z\x3d17\x26t\x3dm\x26q\x3dloc:'+msg.message+'" target\x3d"_blank"\x3e\x3cimg src\x3d"https://maps.googleapis.com/maps/api/staticmap?zoom\x3d17\x26size\x3d200x150\x26center\x3d'+msg.message+"\x26maptype\x3droadmap\x26markers\x3dcolor:red|"+msg.message+"\x26key\x3d"+MCK_MAP_STATIC_API_KEY+'" /\x3e\x3c/a\x3e'}if(typeof msg.fileMeta==="object")if(msg.fileMeta.contentType.indexOf("image")!==
-1)if(msg.fileMeta.contentType.indexOf("svg")!==-1)return'\x3ca href\x3d"#" role\x3d"link" target\x3d"_self" class\x3d"file-preview-link fancybox-media imageview" data-type\x3d"'+msg.fileMeta.contentType+'" data-url\x3d"'+_this.getFileurl(msg)+'" data-name\x3d"'+msg.fileMeta.name+'"\x3e\x3cimg src\x3d"'+_this.getFileurl(msg)+'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e';else if(msg.contentType===5)return'\x3ca href\x3d"#" role\x3d"link" target\x3d"_self" class\x3d"file-preview-link fancybox-media imageview" data-type\x3d"'+
msg.fileMeta.contentType+'" data-url\x3d"'+msg.fileMeta.blobKey+'" data-name\x3d"'+msg.fileMeta.name+'"\x3e\x3cimg src\x3d"'+msg.fileMeta.blobKey+'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e';else if(msg.fileMeta.hasOwnProperty("url"))if(msg.fileMeta.url.indexOf(CLOUD_HOST_URL)!==-1){var thumbnailUrl;_this.generateCloudUrl(msg.fileMeta.thumbnailBlobKey,function(result){thumbnailUrl=result});return'\x3ca href\x3d"#" role\x3d"link" target\x3d"_self" class\x3d"file-preview-link fancybox-media imageview" data-type\x3d"'+
msg.fileMeta.contentType+'" data-url\x3d"" data-blobKey\x3d"'+msg.fileMeta.blobKey+'" data-name\x3d"'+msg.fileMeta.name+'"\x3e\x3cimg src\x3d"'+thumbnailUrl+'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e'}else return'\x3ca href\x3d"#" role\x3d"link" target\x3d"_self" class\x3d"file-preview-link fancybox-media imageview" data-type\x3d"'+msg.fileMeta.contentType+'" data-url\x3d"'+_this.getFileurl(msg)+'" data-name\x3d"'+msg.fileMeta.name+'"\x3e\x3cimg src\x3d"'+msg.fileMeta.thumbnailUrl+'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e';
else if(msg.fileMeta.thumbnailUrl==="thumbnail_"+msg.fileMeta.name)return'\x3ca href\x3d"#" role\x3d"link" target\x3d"_self" class\x3d"file-preview-link fancybox-media imageview" data-type\x3d"'+msg.fileMeta.contentType+'" data-url\x3d"'+_this.getFileurl(msg)+'" data-name\x3d"'+msg.fileMeta.name+'"\x3e\x3cimg src\x3d"'+MCK_STORAGE_URL+"/files/thumbnail_"+msg.fileMeta.name+'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e';else return'\x3ca href\x3d"#" role\x3d"link" target\x3d"_self" class\x3d"file-preview-link fancybox-media imageview" data-type\x3d"'+
msg.fileMeta.contentType+'" data-url\x3d"'+_this.getFileurl(msg)+'" data-name\x3d"'+msg.fileMeta.name+'"\x3e\x3cimg src\x3d"'+msg.fileMeta.thumbnailUrl+'" area-hidden\x3d"true"\x3e\x3c/img\x3e\x3c/a\x3e';else if(msg.fileMeta.contentType.indexOf("video")!==-1)if(msg.fileMeta.hasOwnProperty("url")&&msg.fileMeta.url.indexOf(CLOUD_HOST_URL)!==-1){var getUrl;_this.generateCloudUrl(msg.fileMeta.blobKey,function(result){getUrl=result});return'\x3ca href\x3d"#" target\x3d"_self"\x3e\x3cvideo controls class\x3d"mck-video-player" onplay\x3d"alFileService.updateAudVidUrl(this);" data-cloud-service\x3d"google_cloud" data-blobKey\x3d"'+
msg.fileMeta.blobKey+'"\x3e'+'\x3csource src\x3d"'+getUrl+'" type\x3d"video/mp4"\x3e'+'\x3csource src\x3d"'+getUrl+'" type\x3d"video/ogg"\x3e\x3c/video\x3e'}else return'\x3ca href\x3d "#" target\x3d"_self"\x3e\x3cvideo controls class\x3d"mck-video-player"\x3e'+'\x3csource src\x3d"'+_this.getFileurl(msg)+'" type\x3d"video/mp4"\x3e'+'\x3csource src\x3d"'+_this.getFileurl(msg)+'" type\x3d"video/ogg"\x3e\x3c/video\x3e\x3c/a\x3e';else if(msg.fileMeta.contentType.indexOf("audio")!==-1)if(msg.fileMeta.hasOwnProperty("url")&&
msg.fileMeta.url.indexOf(CLOUD_HOST_URL)!==-1){var getUrl;_this.generateCloudUrl(msg.fileMeta.blobKey,function(result){getUrl=result});return'\x3ca href\x3d"#" target\x3d"_self"\x3e\x3caudio controls class\x3d"mck-audio-player" onplay\x3d"alFileService.updateAudVidUrl(this);" data-cloud-service\x3d"google_cloud" data-blobKey\x3d"'+msg.fileMeta.blobKey+'"\x3e'+'\x3csource src\x3d"'+getUrl+'" type\x3d"audio/ogg"\x3e'+'\x3csource src\x3d"'+getUrl+'" type\x3d"audio/mpeg"\x3e\x3c/audio\x3e'+'\x3cp class\x3d"mck-file-tag"\x3e\x3c/p\x3e\x3c/a\x3e'}else return'\x3ca href\x3d"#" target\x3d"_self"\x3e\x3caudio controls class\x3d"mck-audio-player"\x3e'+
...
conversationPxy}}if(!messagePxy.message&&topicDetail.link){var fileMeta={"blobKey":$applozic.trim(topicDetail.link),"contentType":"image/png"};messagePxy.fileMeta=fileMeta;messagePxy.contentType=5;FILE_META=[];FILE_META.push(fileMeta)}}if(params.isGroup)messagePxy.groupId=params.tabId;else messagePxy.to=params.tabId;mckMessageService.sendMessage(messagePxy)}};_this.getFileUrl=function(msg){};_this.sendVideoCallMessage=function(callId,msgType,contentType,audioOnly,toUser,callback){var message=msgType==
"CALL_MISSED"?"Missed Call":msgType=="CALL_REJECTED"?"Call Rejected":"";if(message==""||message==undefined)message="video message";var metadata={"MSG_TYPE":msgType,"CALL_ID":callId,"CALL_AUDIO_ONLY":audioOnly};var messagePxy={"to":toUser,"type":5,"contentType":contentType,"message":message,"metadata":metadata,"senderName":MCK_USER_ID};callback(messagePxy);return messagePxy};_this.sendVideoCallEndMessage=function(callId,msgType,contentType,audioOnly,callDuration,toUser,callback){var callDurationStr=
"";if(callDuration)callDurationStr=mckDateUtils.convertMilisIntoTime(callDuration);var message=msgType=="CALL_MISSED"?"Missed Call":msgType=="CALL_REJECTED"?"Call Rejected":msgType=="CALL_END"?"Call End \n Duration: "+callDurationStr:"video message";if(message==""||message==undefined)message="video message";var metadata={"MSG_TYPE":msgType,"CALL_ID":callId,"CALL_AUDIO_ONLY":audioOnly,"CALL_DURATION":callDuration};var messagePxy={"to":toUser,"type":5,"contentType":contentType,"message":message,"metadata":metadata};
callback(messagePxy);return messagePxy};_this.getMessageFeed=function(message){var messageFeed={};MCK_FILE_URL=window.Applozic.ALApiService.getFileUrl();messageFeed.key=message.key;messageFeed.timeStamp=message.createdAtTime;messageFeed.message=message.message;messageFeed.from=message.type===4?message.to:MCK_USER_ID;if(message.groupId)messageFeed.to=message.groupId;else messageFeed.to=message.type===5?message.to:MCK_USER_ID;messageFeed.status="read";messageFeed.type=message.type===4?"inbox":"outbox";
if(message.type===5)if(message.status===3)messageFeed.status="sent";else if(message.status===4)messageFeed.status="delivered";if(typeof message.fileMeta==="object"){var file=Object.assign({},message.fileMeta);if(typeof file.url==="undefined"||file.url==="")file.url=MCK_FILE_URL+"/rest/ws/aws/file/"+message.fileMeta.blobKey;delete file.blobKey;messageFeed.file=file}messageFeed.source=message.source;messageFeed.metadata=message.metadata;return messageFeed}};
